...
// - створити функцію яка приймає масив чисел, сумує значення елементів масиву та повертає його. Приклад [input_with_name,products,10]->13
function sumArray(array) {
    ...
    return sum
    // console.log(sum)
    // console.log(a[0] + a[input_with_name] + a[products])
}
